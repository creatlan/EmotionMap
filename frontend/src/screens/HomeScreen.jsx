    ...
    <div className="home-screen">      <Header />
      ...
      {(selectedCoords && (isNewPoint || editPoint)) && (
        <EmotionForm
          ...
          onClose={() => {
            setSelectedCoords(null);            setEditPoint(null);
            setIsNewPoint(false);
          }}
          editPoint={editPoint}
        ...
        >
          ...
          <button
          className="map-button cluster-button"
          onClick={() => {
            toggleMode();
        ...
        >
          ...
          <div className="cluster-popup-standalone">
            <div className="cluster-header">
              <label className="cluster-label">Clusters: {clusterCount}</label>
              <button 
                className="cluster-close-btn" 
                onClick={() => setShowClusterSelector(false)}
                aria-label="Close cluster selector"
              >
                &times;
              </button>
            </div>
            ...
            <input
              ...
              aria-label="Adjust cluster count"
            />
          </div>
        )}
        ...
        </button><button className="map-button" onClick={() => window.mapZoomOut?.()}>
